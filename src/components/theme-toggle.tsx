...
const THEME_EVENT = '8ball-theme-change'
...
/** Dark (default) ↔ light theme toggle. Persists to localStorage; no flash (see layout). */
export function ThemeToggle() {
  ...
  function toggle() {
    ...
    try {
      localStorage.setItem('8ball-theme', next ? 'light' : 'dark')
    } catch {
      /* ignore */
    }
