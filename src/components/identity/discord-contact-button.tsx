...
export function DiscordContactButton({
  ...
  const base = cn(
    'inline-flex items-center justify-center rounded-none border border-border bg-card/60 p-2 text-[#5865F2] transition-colors hover:bg-card hover:text-[#5865F2] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand',
    className,
  )
