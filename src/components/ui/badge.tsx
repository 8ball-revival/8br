  ...
  'cyber-clip-sm inline-flex items-center gap-1 rounded-none border px-2.5 py-0.5 text-[0.7rem] font-semibold uppercase tracking-wider whitespace-nowrap transition-all duration-200',
  {
    variants: {
      variant: {
        ...
        success: 'border-success/50 bg-transparent text-success [text-shadow:0_0_10px_color-mix(in_oklab,var(--success)_50%,transparent)]',
        destructive: 'border-destructive/60 bg-transparent text-destructive [text-shadow:0_0_10px_color-mix(in_oklab,var(--hot-red)_50%,transparent)]',
      },
    },
