...
export function PlayoffWorkspace({
  ...
  /*
    ...
    is not a competitor — it is a coin toss. The seeding rows already carry the CueVerse ID, so the
    identity is looked up by entrant and the board is handed the lookup rather than the rows.
  */
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        ...
        <DraftBracket
          ...
          emptyHint="Select the participants, then Generate Bracket to lay out the draw."
