 ...
 * (admin/archive-review/search) routes are intentionally excluded. Season 1 is the
 * only real season detail page currently published.
 */
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: '/seasons/ego-season-1', priority: 0.6 },
