...
export const metadata: Metadata = pageMetadata({
  title: 'Archived Cups',
  description: 'Every completed Cup in the 8 Ball Registry.',
  path: '/archives/cups',
})
...
export default async function ArchivedTournamentsPage({
  ...
  return (
    <Wide name="archives-cups" className="py-6">
      <h1 className="font-display text-2xl font-bold tracking-tight sm:text-3xl">Archived Cups</h1>
      <p className="mb-4 mt-1 text-sm text-muted-foreground">
        Completed Cups, ordered by the year they were played.
      </p>
      <ArchiveBrowser page={page} kind="cups" />
    </Wide>
  )
}
