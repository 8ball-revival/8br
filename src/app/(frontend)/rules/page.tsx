...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    '8 Ball Registry Official Competition Handbook — conduct, eligibility, match format, group stage, playoffs, scheduling, gameplay, recording, and disputes.',
  path: '/rules',
})
  ...
  return (
    <>
      <PageHeader
        ...
        title="Official Competition Handbook"
        description="This Handbook governs all official 8 Ball Registry competitions."
      />
