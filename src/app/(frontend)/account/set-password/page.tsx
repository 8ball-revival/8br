...
export default async function SetPasswordPage() {
  ...
  return (
    <Container className="max-w-md py-16">
      <div className="cyber-clip border border-brand/40 bg-card/60 p-6" style={{ boxShadow: '0 0 0 1px color-mix(in oklch, var(--gold) 35%, transparent), 0 0 30px -10px color-mix(in oklch, var(--gold) 40%, transparent)' }}>
