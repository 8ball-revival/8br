...
placeholder token set in `globals.css`. **Colors are placeholders** — final EGO branding
...
- **Provenance:** future records carry an imported-historical (8BRCAM legacy) vs native-EGO flag so
