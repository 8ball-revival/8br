...
Handles that collide once punctuation and casing are ignored, and are still separate accounts.
None has been merged. Two spellings looking alike is not evidence that two people are one —
the archive prints both spellings of most of these in their own right, and attaching one
person's record to another is far harder to undo than merging two accounts later.

| A | Seasons | B | Seasons | Why no merge |
|---|---|---|---|---|
...
| `gbwarrior1` (gbwarrior1) | 2 | `gb_warrior1` (gb_warrior1) | 2 | no Season in common, but nothing proves they are one person |
| `a_d_a_m__` (a_d_a_m__) | 3 | `A_D_A_M_` (A_D_A_M_) | 1 | both appear in 1 of the same Season(s) — likely two people |
| `u.nderrated` (u.nderrated) | 9 | `underrated` (underrated) | 1 | both appear in 1 of the same Season(s) — likely two people |
| `stud+muffin+69` (stud+muffin+69) | 7 | `stud+muffin_69` (stud+muffin_69) | 1 | both appear in 1 of the same Season(s) — likely two people |
| `xlxmooneyxlx` (xlxmooneyxlx) | 5 | `xlx_mooney_xlx` (xlx_mooney_xlx) | 1 | both appear in 1 of the same Season(s) — likely two people |

## Bracket handles with no account in their Season

These occupy an entry position on an archived bracket but are not entrants in that Season, so
...
| `ll_ketan_ll` | `l_ketan_l` | `cmt0q1ad6001t6rpo2lf471ji` |
| `luisj_barreto` | `real_creampuff` | `cmsxh8m4l00006rf405ws72ne` |
| `Mario` | `Miz` | `cmsxiy66q000o6rzkwxg1h313` |
| `mj_the_king` | `pool.instinct` | `cmt0q3eyc00206rpo0313fhcm` |
| `xxl_machine_lxx` | `xxl_themachine_lxx` | `cmt1nniq7000d6r0c3y471in8` |
| `xlx_k_e_t_a_n_xlx` | `l_ketan_l` | `cmt0q1ad6001t6rpo2lf471ji` |
| `bigblue2k` | `sixohtwo` | `cmsyrx31g00006riggac6o23n` |
| `Sean` | `sixohtwo` | `cmsyrx31g00006riggac6o23n` |
