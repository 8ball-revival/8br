...
| `NEXT_PUBLIC_SITE_URL` | `https://8br.gg` — drives canonical URLs, sitemap, Payload serverURL/CORS/CSRF, secure cookies | Production |
...
- **Domain rollback:** Vercel → Domains → reassign `8br.gg` to a prior deployment, or repoint DNS at the registrar.
