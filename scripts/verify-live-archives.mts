...
section('Navigation offers one permanent destination per competition type')
{
  ...
  const pub = buildNav({})
  check('the public order is Home · Seasons · Tournaments · Rankings · Yahoo · Achievements · The Break',
    labels(pub) === 'Home · Seasons · Tournaments · Rankings · Yahoo · Achievements · The Break', labels(pub))
  ...
  check('the administrative order is Home · Seasons · Tournaments · Creator · Rankings · Yahoo · Achievements · The Break · Admin',
    labels(admin) === 'Home · Seasons · Tournaments · Creator · Rankings · Yahoo · Achievements · The Break · Admin', labels(admin))
