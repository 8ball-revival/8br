# WCC — World Cue Championships · PROJECT PLAN

**WCC — World Cue Championships**
<sub>formerly known as WCC</sub>
...
- **Primary title:** `WCC`
- **Full name:** `World Cue Championships`
- **Legacy line:** `formerly known as WCC` — treated as **secondary legacy text**, never part of the primary logo or main title.
...
WCC is the competitive organization and historical home for CueVerse online pool competition. It serves:
...
| Category | Role |
|---|---|
| **Seasons** | The **primary** recurring WCC competition. |
...
- **History** contains the legacy **WCC archive** and must clearly distinguish **historical records** from **current WCC competitions** (see §7 provenance).
...
- **Provenance flag:** every record is marked as **imported historical (WCC legacy)** vs **native WCC** so the two are always distinguishable in data and UI. Confidence/provenance signals from the source (`champion_confidence`, `bracket_reconstructed`, `source_kind`) are carried through, not dropped.
...
- **Phase 2 — Public archive (read-only):** Seasons/Cups/Tournaments, Standings, Players, History (WCC archive), Hall of Fame, Rules, News; search/filter; CSV/JSON exports.
...
6. **Live vs. historical scope timing** — when native WCC competitions begin being entered alongside the imported archive.
